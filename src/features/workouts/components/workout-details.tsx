          ...
          return (
            <Card key={exercise.id} className="overflow-hidden">
              ...
              <CardContent className="p-0">
                <div className="grid grid-cols-[3rem_1fr_1fr] gap-2 px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider bg-muted/30 border-y">
                  <div className="text-center">Set</div>
                  <div className="text-center">kg</div>
                  <div className="text-center">Reps</div>
                </div>

                <div className="flex flex-col gap-[1px] bg-muted/10">
                  {completedSets.map((set, index) => (
                    <div key={set.id} className="grid grid-cols-[3rem_1fr_1fr] gap-2 items-center py-2 px-3 bg-background">
